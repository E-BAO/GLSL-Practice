...
GLfloat shin[] = { 10 };
GLfloat const_att[] = {0.3};
GLfloat linear_att[] = {0.1};
GLfloat quad_att[] = {0.0};
GLfloat spotDir[] = {-0.3,-0.2,-1.0,-1.7};
GLfloat spotCutoff[] = {30.0}; //cos(60d)
GLfloat spotExp[] = {5.0};
...
void renderScene(void) {
    ...
    glLightfv(GL_LIGHT0, GL_AMBIENT_AND_DIFFUSE, globalAmbient);
    ...
    glLightfv(GL_LIGHT1, GL_AMBIENT_AND_DIFFUSE, globalAmbient);
    glLightfv(GL_LIGHT1, GL_CONSTANT_ATTENUATION, const_att);
    glLightfv(GL_LIGHT1, GL_LINEAR_ATTENUATION, linear_att );
...
void processNormalKeys(unsigned char key, int x, int y) {
    ...
    printf("x=%f,y=%f,z=%f",spotDir[0],spotDir[1],spotDir[2]);
    if (key == 27)
        exit(0);
}
